...
namespace HRIS.Infrastructure.Migrations
{
    ...
    [Migration("20240912034749_AddWorkflow")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRIS.Domain.Entities.NextStepRule", b =>
                {
            ...
            modelBuilder.Entity("HRIS.Domain.Entities.Process", b =>
                {
                    b.Property<int>("ProcessId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HRIS.Domain.Entities.Workflow", b =>
                {
                    b.Property<int>("WorkflowId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HRIS.Domain.Entities.WorkflowAction", b =>
                {
            ...
            modelBuilder.Entity("HRIS.Domain.Entities.WorkflowSequence", b =>
                {
                    b.Property<int>("StepId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HRIS.Domain.Entities.LeaveRequest", b =>
                {
                    b.HasOne("HRIS.Domain.Entities.AppUser", "Employee")
                        .WithMany("LeaveRequests")
                        .HasForeignKey("EmployeeId");

                    b.HasOne("HRIS.Domain.Entities.Process", "Process")
                        .WithMany("LeaveRequests")
            ...
            modelBuilder.Entity("HRIS.Domain.Entities.NextStepRule", b =>
                {
                    b.HasOne("HRIS.Domain.Entities.WorkflowSequence", "CurrentStep")
                        .WithMany("NextStepRules")
                        .HasForeignKey("CurrentStepId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HRIS.Domain.Entities.WorkflowSequence", "NextStep")
                        .WithMany()
            ...
            modelBuilder.Entity("HRIS.Domain.Entities.Process", b =>
                {
                    b.HasOne("HRIS.Domain.Entities.NextStepRule", "CurrentStep")
                        .WithMany()
                        .HasForeignKey("CurrentStepId");

                    b.HasOne("HRIS.Domain.Entities.AppUser", "Requester")
                        .WithMany("Processes")
                        .HasForeignKey("RequesterId");

                    b.HasOne("HRIS.Domain.Entities.Workflow", "Workflow")
                        .WithMany("Processes")
            ...
            modelBuilder.Entity("HRIS.Domain.Entities.WorkflowAction", b =>
                {
                    b.HasOne("HRIS.Domain.Entities.AppUser", "Actor")
                    ...
                    b.HasOne("HRIS.Domain.Entities.WorkflowSequence", "Step")
                        .WithMany("WorkflowActions")
